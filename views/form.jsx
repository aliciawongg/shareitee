...
class Form extends React.Component {
  render() {
     console.log('Display iti form');
     // var url= "/shareitee/newiti";
    return (
        <Default>
                ...
                <div className="col-10 offset-1">
                    ...
                    <form method="POST">
                        ...
                        <div className="form-row">
                          ...
                          <div className="form-group col-6">
                            <label>Day 2</label>
                            <input type="text" className="form-control" id="day2" name="day2"/>
                          </div>
                        </div>
                        <div className="form-row">
                          <div className="form-group col-6">
                            <label>Day 3</label>
                            <input type="text" className="form-control" id="day3" name="day3"/>
                          </div>
                          <div className="form-group col-6">
                            <label>Day 4</label>
                        ...
                        <div className="form-check form-check-inline">
                            <input className="form-check-input" type="radio" name="seasons" id="seasons" value="summer"/>
                            <label className="form-check-label">Summer</label>
                        </div>
                        <div className="form-check form-check-inline">
                            <input className="form-check-input" type="radio" name="seasons" id="seasons" value="autumn"/>
                            <label className="form-check-label" >Autumn</label>
                        </div>
                        <div className="form-check form-check-inline">
